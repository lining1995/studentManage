                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" onsubmit="return check();"
                              action="../subjectScore/addSubjectScore.do">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" name="studentVo_name"
                                           value="${studentVo.name}" disabled="disabled"/>
                                </div>
                            </div>

                            <div class="form-group ">
                                <label class="col-sm-3 control-label no-padding-right" for="subject_select">课程</label>
                                <div class="col-xs-10 col-sm-5">
                                    <select class="form-control " id="subject_select" name="subject_select">
                                        <%--<option value=""></option>--%>
                                        <c:forEach var="subjectVo" items="${subjectVos}">
...
<script type="text/javascript">
    function check() {
        if (document.getElementById("subject_select").options.length!=0) {
            return true;
        }else{
            alert("课选完了？");
            return false;
