        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="../grade/getGradeAll.do">班级管理</a>
                    </li>
                    <c:if test="${gradeVo==null}">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" onsubmit="return check();"
                              <c:if test="${gradeVo==null}">action="../grade/addGrade.do" </c:if>
                              <c:if test="${gradeVo!=null}">action="../grade/updateGrade.do" </c:if>>
                            <input value="${gradeVo.id}" type="text" name="grade_id" hidden="hidden"/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="grade_name"> 班级名称</label>

                                <div class="col-sm-9">
                                    <input type="text" id="grade_name" placeholder="Username" class="col-xs-10 col-sm-5" name="grade_name"
                                           value="${gradeVo.name}" />
                                </div>
                            </div>
...
<script type="text/javascript">
    function check() {
        if (document.getElementById("grade_name").value != "") {
              return true;
        }else{
            alert("班级名称不能为空");
            return false;
