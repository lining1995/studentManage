        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="../subject/getSubjectAll.do">科目管理</a>
                    </li>
                    <c:if test="${subjectVo==null}">
                        <li class="active">添加科目信息</li>
                    </c:if>
                    <c:if test="${subjectVo!=null}">
                        <li class="active">修改科目信息</li>
                    </c:if>
                </ul><!-- /.breadcrumb -->
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" onsubmit="return check();"
                              <c:if test="${subjectVo==null}">action="../subject/addSubject.do" </c:if>
                              <c:if test="${subjectVo!=null}">action="../subject/updateSubject.do" </c:if>>
                            <input value="${subjectVo.id}" type="text" name="subject_id" hidden="hidden"/>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="subject_name"> 科目名称</label>

                                <div class="col-sm-9">
                                    <input type="text" id="subject_name" placeholder="Username" class="col-xs-10 col-sm-5" name="subject_name"
                                           value="${subjectVo.name}" />
                                </div>
                            </div>
